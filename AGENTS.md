...
## Repository map
- `app.rc/` — explain what lives here and when agents should edit it.
- `app.syso/` — explain what lives here and when agents should edit it.
...
- `FortressVision.exe/` — explain what lives here and when agents should edit it.
- `fv.exe/` — explain what lives here and when agents should edit it.
